    ...
    <div class="app-wrapper">
        ...
        <main class="app-main">
            ...
            <div class="app-content">
                ...
                <div class="container-fluid">
                    @if (!empty($task[0]['id']))
                    <form class="needs-validation" action="{{ url('tasks/edittask/'.$task[0]['id']) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Body-->
                        <div class="card-body">
                            <!--begin::Row-->
                            <div class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="task_name" name="task_name" value="{{ $task[0]['task_name'] }}" required>
                                    @error('task_name')
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="project" name="project" required>
                                        ...
                                        @foreach ($projects as $pkey => $project)
                                            <option value="{{ $project->id }}" @if ($task[0]['project_id']==$project->id) selected @endif>{{ $project->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="task_status" name="task_status" >
                                        <option value="">-- SELECT --</option>
                                        <option value="ToDo" @if ($task[0]['status']=='ToDo') selected @endif>ToDo</option>
                                        <option value="In-Progress" @if ($task[0]['status']=='In-Progress') selected @endif>In-Progress</option>
                                        <option value="Done" @if ($task[0]['status']=='Done') selected @endif>Done</option>
                                    </select>
                                    <div class="invalid-feedback"></div>
                                </div>
                                <!--end::Col-->
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="task_duedate" name="task_duedate" value="{{ $task[0]['due_date'] }}">
                                    @error('task_duedate')
                                    <div class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </div>
